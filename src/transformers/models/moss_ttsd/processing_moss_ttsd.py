...
class MossTTSDProcessor(ProcessorMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], **kwargs):
        ...
        """
        audio_tokenizer_path = kwargs.pop("audio_tokenizer_path", os.path.join(pretrained_model_name_or_path, "XY_Tokenizer"))
        ...
        feature_extractor = AutoFeatureExtractor.from_pretrained(audio_tokenizer_path, trust_remote_code=True, **kwargs)
